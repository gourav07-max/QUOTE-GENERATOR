        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarcontent">
                <ul class="navbar-nav mt-5 pr-5">
                   ...
                   <li class="nav-item">
                       <a href="https://www.thesparksfoundationsingapore.org/" class="nav-link"><span class="fa fa-info-circle"></span>About Us</a>
                   </li>
                   <li class="nav-item">
                       <a href="qna.php" class="nav-link"><span class="fa fa-eye"></span>Contact Us</a>
                   </li>
                </ul>
            </div>
        </nav>
