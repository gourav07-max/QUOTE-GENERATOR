...
<div class="container-fluid">
        ...
        <div class="row row-content">
                <div class="col-12 offset-sm-1 col-sm-10">
                    <h2 style="padding-top: 120px ;text-align: center; padding-bottom: 5px; color: white; "><b><i>ACCOUNT DETAILS</i></b></h2>
                    <div class="table-responsive tb">
                        <table class="table table-striped">
                            ...
                            if(count($rows)>0){
                                ...
                                <td style="text-tranform: uppercase; text-decoration: none;"><?php echo('<a href="profile.php?user_id='.$row['id'].'">'.htmlentities($row['users']).'</a> ');
                                                ?>  </td>
                                <td><?php echo htmlentities($row['email']); ?> </td>
                                <td><?php echo htmlentities($row['amount']); ?> </td>
                                <td>
                                    <button>
                                        <?php  echo('<a href="profile.php?id='.$row['id'].'">'."View".'</a> ');?>
                                    </button>
                                </td>
                                </tr>
                                <?php }
